...
export function addAllScreens(scene) {
    ...
    addVideoScreen(scene, 'video/zombieatk.mp4', { x:  -20, y: 5, z: -66 }, { x: 0, y: 5 *Math.PI / -4, z: 0 });
    addVideoScreen(scene, 'video/ddnet.mp4', { x:  -40, y: 5, z: -86 }, { x: 0, y: 5 *Math.PI / -4, z: 0 });
    ...
    addVideoScreen(scene, 'video/vr.mp4', { x:  -35, y: 5, z: -114 }, { x: 0, y: 0, z: 0 });
